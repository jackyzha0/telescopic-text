...
function _hydrate(line, node, hoverable) {
...
// telescoping text.
function _createTelescopicText(content, hoverable) {
    if (hoverable === void 0) { hoverable = false; }
...
function createTelescopicTextFromBulletedList(listContent, _a) {
    var _b = _a === void 0 ? _DEFAULT_CONFIG : _a, separator = _b.separator, hoverable = _b.hoverable;
