...
function _hydrate(line, node, config) {
    ...
    var shouldExpandOnMouseOver = config.shouldExpandOnMouseOver, _a = config.textMode, textMode = _a === void 0 ? TextMode.Text : _a;
...
function createTelescopicTextFromBulletedList(listContent, _a) {
    var _b = _a === void 0 ? {} : _a, _c = _b.separator, separator = _c === void 0 ? " " : _c, _d = _b.shouldExpandOnMouseOver, shouldExpandOnMouseOver = _d === void 0 ? false : _d, _e = _b.textMode, textMode = _e === void 0 ? TextMode.Text : _e;
    ...
    return _createTelescopicText([content], {
        shouldExpandOnMouseOver: shouldExpandOnMouseOver,
        textMode: textMode,
    });
}
